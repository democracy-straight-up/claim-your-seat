...
class PasswordResetSerializer(serializers.Serializer):
    uidb64 = serializers.CharField(required=True) # uidb64 is the user id encoded in base64
    # TODO: add a new generator for the token
    token = serializers.CharField(required=True) # token is the token generated by the account_activation_token
